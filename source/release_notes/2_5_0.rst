...
.. |See WEB UI configuration guide| replace:: See WEB UI configuration guide
.. _See WEB UI configuration guide: https://moira.readthedocs.io/en/release-2.5/installation/configuration.html#web-ui
...
- add **label** (new required field). You can see default type and label mappings in |default WEB UI configuration|_ 
- **title** rename to "placeholder"
See |See WEB UI configuration guide|_ and for more information.
